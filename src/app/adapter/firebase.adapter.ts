import { ChatAdapter, Message, UserStatus, User } from 'ng-chat';
...
export class FirestoreAdapter extends ChatAdapter
{
  public static mockedUsers: User[] = [
    ...
    listFriends(): Observable<User[]> {
        return of(FirestoreAdapter.mockedUsers);
    }
    ...
    sendMessage(message: Message): void {
        setTimeout(() => {
            ...
            const user = FirestoreAdapter.mockedUsers.find(x => x.id === replyMessage.fromId);
